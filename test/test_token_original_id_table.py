    ...
    def test_get_symbol_uuid(self):
        with patch.object(requests, "get", new=TestTokenOriginalIdTable.mock_get):
            with patch.object(
                ...
                symbol_uuid = token_original_id_table.get_symbol_uuid(
                    "osmosis",
                    "ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2",
                )
    ...
    def test_get_chain(self):
        with patch.object(requests, "get", new=TestTokenOriginalIdTable.mock_get):
            with patch.object(
                ...
                chain = token_original_id_table.get_chain(
                    "osmosis",
                    "ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2",
                )
    ...
    def mock_DictReader(cls, src):
        token_original_id_table = [
            ...
            },
            {
                ...
                "symbol": "umee",
                "description": "Umee is a cross chain DeFi hub that interconnects between blockchains",
                "chain": "osmosis",
